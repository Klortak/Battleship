...
class Ship():
    ...
    def attack(self, grid, coord):
        ...
        if coord in self.possibleCoords:
            ...
            # If all possible coordinates are hit, sink the ship
...
ships = [
    ...
    Ship('Submarine', 3, board),
    Ship('Destroyer', 2, board)
]

for x in ships:
    print(x.possibleCoords)
...
while len(ships) > 0 and turns > 0:
    ...
    try:
        ...
        print('### Coordinate has already been attacked ###')
    except IndexError:
